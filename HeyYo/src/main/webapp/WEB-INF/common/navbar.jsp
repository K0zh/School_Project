...
<nav class="navbar navbar-fixed-top navbar-inverse">
	<div class="container-fluid">
		<div class="col-xs-2">
			<div id="navbar" class="text-left">
				<a class="navbar-brand glyphicon glyphicon-menu-hamburger" href="#menu-toggle" id="menu-toggle"> 
				</a>
			</div>
		</div>
  ...
  <div class="col-lg-6">
    <div class="input-group">
      ...
      <input type="text" class="form-control" placeholder="키워드" aria-label="..." name="talent">
      <span class="input-group-btn">
        <button class="btn btn-default" type="button" onclick = "talentClick()">
  ...
  <div class="col-lg-6">
    <div class="input-group">
      <input type="text" class="form-control" placeholder="지역명" name="location">
      <span class="input-group-btn">
		...
		<div class="col-xs-2">
			<div id="navbar" class="navbar-right">
				<a class="navbar-brand glyphicon glyphicon-user" href="#" data-toggle="modal" data-target="#loginModal">
				</a>
			</div>
		</div>
	</div>
